class config(object):
    def __init__(self):
        self.data_path='../data/questions.txt'            #path of data for training language model   
        self.use_data_path='./input/input.txt'                         #data path of keywords
        self.dict_path='../data/dict.pkl'                    #dictionary path
        ...
        self.vocab_size=self.dict_size+3+1
